...
<div class="wrapper">
            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        ...
                        <ul class="dropdown-menu notif-box" aria-labelledby="navbarDropdown">
                            ...
                            <li>
                                <div class="notif-center">
                                    ...
                                    <a href="#">
                                        <div class="notif-img">
                                            <img src="{{asset('public/admin_dashboard/img/profile2.jpg')}}" alt="Img Profile">
                                        </div>
                                        <div class="notif-content">
												<span class="block">
                    ...
                    <li class="nav-item dropdown">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false"> <img src="{{asset('public/admin_dashboard/img/profile.jpg')}}" alt="user-img" width="36" class="img-circle">
                            <span >{{ Auth::user()->name }}</span></span> </a>
                        <ul class="dropdown-menu dropdown-user">
                            <li>
                                <div class="user-box">
                                    <div class="u-img"><img src="{{asset('public/admin_dashboard/img/profile.jpg')}}" alt="user"></div>
                                    <div class="u-text">
                                        <h4>{{ Auth::user()->name }}</h4>
                                        <p class="text-muted">Admin</p><a href="profile.html" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
                                </div>
                            </li>
                            <div class="dropdown-divider"></div>
    ...
    <div class="sidebar">
        <div class="scrollbar-inner sidebar-wrapper">
            <div class="user">
                <div class="photo">
                    <img src="{{asset('public/admin_dashboard/img/profile.jpg')}}">
                </div>
                <div class="info">
...
<script src="{{asset('public/admin_dashboard/js/core/bootstrap.min.js')}}"></script>
<script src="{{asset('public/admin_dashboard/js/plugin/chartist/chartist.min.js')}}"></script>
<script src="{{asset('public/admin_dashboard/js/plugin/chartist/plugin/chartist-plugin-tooltip.min.js')}}"></script>
{{--<script src="{{asset('public/admin_dashboard/js/plugin/bootstrap-notify/bootstrap-notify.min.js')}}"></script>--}}
<script src="{{asset('public/admin_dashboard/js/plugin/bootstrap-toggle/bootstrap-toggle.min.js')}}"></script>
<script src="{{asset('public/admin_dashboard/js/plugin/jquery-mapael/jquery.mapael.min.js')}}"></script>
<script src="{{asset('public/admin_dashboard/js/plugin/chart-circle/circles.min.js')}}"></script>
